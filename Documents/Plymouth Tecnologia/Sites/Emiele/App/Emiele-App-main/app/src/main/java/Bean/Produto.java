...
public class Produto {
    ...
    //n(nullable = false, unique = false, length = 30)
    private String codigo;
    //n(nullable = false, unique = false, length = 300)
    private String descricao;
    //n(nullable = false, unique = false, length = 100)
    private String precoun;
    //n(nullable = true, unique = false, length = 100)
    ...
    //n(nullable = true, unique = false, length = 20)
    private String UnidadeTributavel;
    //n(nullable = false, unique = false, length = 20)
    private String data;
    //n(nullable = true, unique = false, length = 20)
