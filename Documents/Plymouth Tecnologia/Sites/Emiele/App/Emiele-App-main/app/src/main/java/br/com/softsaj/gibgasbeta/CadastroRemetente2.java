...
public class CadastroRemetente2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastro_remetente2);

        getSupportActionBar().hide();
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);

        //-------------------------------
        remetente = CadastroRemetente.getRemetente();
    ...
    private void alert(String msg){
        Toast.makeText(CadastroRemetente2.this, msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public void PegaValores(){
        ...
        if(!(remetente.getRua().equals("") && remetente.getBairro().equals("") && remetente.getNumero().equals("")
             ...
             */
            startActivity(new Intent(getBaseContext(), CadastroRemetente3.class));
