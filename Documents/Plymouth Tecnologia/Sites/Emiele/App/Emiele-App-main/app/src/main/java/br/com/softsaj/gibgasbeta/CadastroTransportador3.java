...
public class CadastroTransportador3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastro_transportador3);

        //-----------------------------------------------
        remetente = CadastroTransportador2.getTransportador();
        ...
        //Inicializa firebase
        FirebaseApp.initializeApp(CadastroTransportador3.this);
    ...
    public void PegaValores(){
        ...
        remetente.setRamo("Transportador");
    ...
    private void criaUsuario(String email, String senha) {
        auth.createUserWithEmailAndPassword(email,senha)
                .addOnCompleteListener(CadastroTransportador3.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            if(user == null){
                                ...
                                databaseReference.child("Transportador").child(remetente.getId()).setValue(remetente);
    ...
    private void alert(String msg){
        Toast.makeText(CadastroTransportador3.this, msg, Toast.LENGTH_SHORT).show();
    }

    public void Autenticar_num(){

        ConfirmacaoTel.tipo(2);
