...
public class Criar_Viagem_Config_Moto extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_enviar_motocicleta, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cadastrar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.container, new Cadastrar_Motocicleta()).commit();
    ...
    private void PegaOp() {
        ...
        if(vouatevc.isChecked()){
            ...
            //Add Moto
            viagem.setTipoAuto("Motocicleta");
            viagem.setModelo("");
            viagem.setPotencia("");
            viagem.setCor("");
    ...
    public void iniciacomponentes(){
        ...
        for(Veiculo veiculo: veiculos){
            if(veiculo.getTipo().equals("Motocicleta")){
