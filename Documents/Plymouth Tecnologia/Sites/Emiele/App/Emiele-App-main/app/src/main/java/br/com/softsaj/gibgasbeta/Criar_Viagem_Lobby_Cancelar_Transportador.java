...
public class Criar_Viagem_Lobby_Cancelar_Transportador extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.cancelar_viagem_transportador, container, false);
    }
    ...
    public void IniciaPRocessoCancelamento(){
        ...
        if(remessa.getStatus().toString().equals("Mercadoria_Entregue")
            ...
            databaseReference.child("Remessa_Aceite").child(remessa.getChave()).setValue(remessa);
            //Pega informações e Volta dinheiro para conta no GibGas do Remetente
