...
public class Criar_Viagem_Lobby_Reportar_Transportador extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.reportar_viagem_transportador, container, false);
    }
    ...
    public void init(){
        Reportar = (Button) getView().findViewById(R.id.button38);
    ...
    public void IniciaPRocessoReportar(){
        ...
        if(remessa.getStatus().toString().equals("Mercadoria_Entregue")
            ...
            if(motivo.equals("")){
                ...
                remessa.setMotivo_Analise("Transportador: "+motivo);
                ...
                analise.setQueixado("Remetente");
                analise.setQueixou("Transportador");
            ...
            alert("Ação Inválida! Se desejar, cancele a viagem.");
        }
