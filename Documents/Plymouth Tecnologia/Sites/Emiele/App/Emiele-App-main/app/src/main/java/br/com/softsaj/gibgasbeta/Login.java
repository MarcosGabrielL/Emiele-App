...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bcadastrar = (Button) findViewById(R.id.button2);
        Button blogin = (Button) findViewById(R.id.button);
        //Button brastreio = (Button) findViewById(R.id.button3);
       ...
       /* brastreio.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {

                /**
                 * Evento Botão Rastrear
                 *
